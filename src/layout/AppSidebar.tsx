...
const AppSidebar: React.FC = () => {
  ...
  const sidebarTransformClass = i18n.language === "ar"
  ...
  return (
    <aside
      className={`fixed mt-16 flex 
        flex-col lg:mt-0 top-0 px-5 bg-white
         dark:bg-gray-900 dark:border-gray-800
          text-gray-900 h-screen transition-all duration-300
           ease-in-out z-50 border-r border-gray-200 ${sidebarTransformClass} 
