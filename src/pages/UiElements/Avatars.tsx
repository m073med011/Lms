...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | Academix - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for Academix - React.js Tailwind CSS Admin Dashboard Template"
      />
